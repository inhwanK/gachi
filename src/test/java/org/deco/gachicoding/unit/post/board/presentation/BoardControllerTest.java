...
public class BoardControllerTest {
    ...
    void write_writeBoardWithUser_Success() throws Exception {
        ...
        BoardSaveRequest request = BoardMockFactory.mockBoardSaveRequest(userEmail, boardTitle, boardContents, boardCategory);
    ...
    void read_readAllEnableList_Success() throws Exception {
        ...
        BoardResponseDto boardResponseDto1 = BoardMockFactory.mockBoardResponseDto(1L, user, true);
        BoardResponseDto boardResponseDto2 = BoardMockFactory.mockBoardResponseDto(2L, user, true);
        BoardResponseDto boardResponseDto3 = BoardMockFactory.mockBoardResponseDto(3L, user, true);
        ...
        List<BoardResponse> boardResponses = List.of(
                BoardMockFactory.mockBoardResponse(boardResponseDto1),
                BoardMockFactory.mockBoardResponse(boardResponseDto2),
                BoardMockFactory.mockBoardResponse(boardResponseDto3)
        );
    ...
    void read_readEnableDetail_Success() throws Exception {
        ...
        BoardResponseDto boardResponseDto = BoardMockFactory.mockBoardResponseDto(boardIdx, user, true);

        given(boardService.getBoardDetail(any(BoardDetailRequestDto.class)))
                .willReturn(boardResponseDto);

        BoardResponse boardResponse = BoardMockFactory.mockBoardResponse(boardResponseDto);
    ...
    void modify_modifyBoard_Success() throws Exception {
        ...
        BoardUpdateRequest request = BoardMockFactory.mockBoardUpdateRequest(user.getUserEmail(), boardIdx, boardTitle, boardContents);
    ...
    public void modify_modifyNotExistTitle_Exception() throws Exception {
        ...
        BoardUpdateRequest request = BoardMockFactory.mockBoardUpdateRequest(user.getUserEmail(), boardIdx, null, boardContents);
    ...
    public void modify_modifyEmptyTitle_Exception() throws Exception {
        ...
        BoardUpdateRequest request = BoardMockFactory.mockBoardUpdateRequest(user.getUserEmail(), boardIdx, "", boardContents);
    ...
    public void modify_modifyNotExistContents_Exception() throws Exception {
        ...
        BoardUpdateRequest request = BoardMockFactory.mockBoardUpdateRequest(user.getUserEmail(), boardIdx, boardTitle, null);
    ...
    public void modify_modifyEmptyContents_Exception() throws Exception {
        ...
        BoardUpdateRequest request = BoardMockFactory.mockBoardUpdateRequest(user.getUserEmail(), boardIdx, boardTitle, "");
