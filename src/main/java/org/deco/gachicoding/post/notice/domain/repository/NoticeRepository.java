...
//    Page<Notice> findByNotContentsContainingIgnoreCaseAndNotActivatedTrueOrNotTitleContainingIgnoreCaseAndNotActivatedTrueOrderByNotIdxDesc(String notContent, String notTitle, Pageable pageable);
