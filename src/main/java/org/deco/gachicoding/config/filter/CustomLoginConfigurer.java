...
public class CustomLoginConfigurer<H extends HttpSecurityBuilder<H>> extends
    ...
    public CustomLoginConfigurer successHandlerCustom(AuthenticationSuccessHandler successHandler) {
        this.successHandler = successHandler;
        return this;
    }

    public CustomLoginConfigurer failureHandlerCustom(AuthenticationFailureHandler failureHandler) {
        this.failureHandler = failureHandler;
        return this;
    }

    public CustomLoginConfigurer setAuthenticationManager(AuthenticationManager authenticationManager) {
